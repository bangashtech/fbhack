    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtu.be/A9LYVMxR98Q')
                time.sleep(2)
                menu()
